...
vars = {
  ...
  'skia_revision': '22f80a60b17f4c82efd7cf43fa4e43863022ec45',
  ...
  'dart_revision': 'e4c9b06267d32507ead537df60d5b17d1a1dcca6',
...
deps = {
  'src': 'https://github.com/dwrobel/buildroot.git@dw-9:8a0bc70c20c3570527ddbfaef2a14ed16fed4a66',
     ...
     'packages': [
       {
        ...
        'version': 'OUQEzH1oEjxojFInHpvPuu5ue_LyyEQsWBt68XE75JkC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'rnN_X2o75mOgEr8aYckFDGZp6dq8lRY-rq0ctcHeKB4C'
       }
     ],
