...
vars = {
  ...
  'skia_revision': '7cf3addb1bd852e316ca9ad42ccd48e8a832ffde',
  ...
  'dart_watcher_rev': '14706140b3670ca1dfeca73480bdd3091b728ce9',
...
deps = {
  'src': 'https://github.com/dwrobel/flutter-buildroot.git@lgi-2.12.0-240.0.dev:049b9c19fca4c4ed76e22796bc6850a8f1348e6d',
  ...
  'src/third_party/dart/third_party/pkg/args':
   Var('dart_git') + '/args.git@2c6a221f45e4e0ef447b5d09101bf8a52e1ccd36',
  ...
  'src/third_party/dart/third_party/pkg/matcher':
   Var('dart_git') + '/matcher.git@63f1110a657fb5e2dc378db8895fef7b0a13ab30',
     ...
     'packages': [
       {
        ...
        'version': 'oll0Dgp9o9iXjcpj8D5WGBWcGsSA1VuMPaLy-vKnXpAC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'UB6RsTbdUqWcqhy9BBMzUewWebCZQ-EhG5Nir2pXng4C'
       }
     ],
