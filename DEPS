...
vars = {
  ...
  'dart_revision': '2ea318b540948b55306bf82fd34b2c84ec634f48',
...
deps = {
  'src': 'https://github.com/dwrobel/buildroot.git@dw-8:c8700203d801019bdfed92ea05ad42f6b99e8f7c',
     ...
     'packages': [
       {
        ...
        'version': 'K1oZWWtBnXpLPGw2K5jmrH5rxmxQDw3Ok9nXiYOgr-AC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '9kiAbu3bddBeZAkCDWf7byTpH5zBfMEROQXB1rRx32UC'
       }
     ],
