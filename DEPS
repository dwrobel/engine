...
vars = {
  ...
  'skia_revision': '51ab694cbb860c51a3677033090d0897e7078cd6',
  ...
  'dart_revision': '2b88e9de118097d12183aa30ec9f8c6bed9d64fc',
...
deps = {
  'src': 'https://github.com/dwrobel/buildroot.git@dw-9.1:231cd6cea1b28804ff16efec15f6e262a58c36d0',
  ...
  'src/third_party/dart/third_party/pkg/crypto':
   Var('dart_git') + '/crypto.git@a5ec902dda5a635a35c6b363ec64458cf84c5872',
  ...
  'src/third_party/dart/third_party/pkg/shelf':
   Var('dart_git') + '/shelf.git@5a77d25861db91db4343b19dfe213b8992e0a837',
     ...
     'packages': [
       {
        ...
        'version': '1LDC_Iu1_Fyb_gLHvfCV_2aJ2rnH10AV6e9GKQ-_SNUC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '3EfPHtl7GzvXpRt-diXGPoZOkCdekd-pDsDL4HtgCXIC'
       }
     ],
